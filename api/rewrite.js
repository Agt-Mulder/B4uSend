  ...
  try {
    ...
    const prompt = `
      ...
      **CRITICAL INSTRUCTIONS:**
      ...
      4.  **Required JSON Output:** Your entire response **MUST** be a single, valid JSON object with four string keys: "subject", "original_greeting", "rewritten_body", and "original_signature". The "subject" key is mandatory and must not be empty. If other parts don't exist, return an empty string for those keys.
